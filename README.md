...
- **Для каждой группы:** копирует шаблон, первый лист каждого xlsx-инвойса (с форматированием, 25% масштаб, все столбцы видимы), заполняет лист **Total**: колонка B — номера счетов, J — ЭСД, O — декларации GTD.
